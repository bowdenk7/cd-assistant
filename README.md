...
#### Writing a `.d.ts` file
If generating a `.d.ts` using `dts-gen` isn't working, [you should tell me about it first](#feedback), but then you can create your own `.d.ts` file.
...
If you're not interested, [you should tell me why](#feedback) so we can help make it easier in the future!
...
However, if prescriptive guidance on testing is something that you're interested in, [let me know](#feedback), I'll do some homework and get back to you.
...
If you are interesting in seeing TSLint feedback as soon as possible, I strongly recommend the [TSLint extension in VS Code](#tslint).
...
#Feedback
This project is meant to help you be successful with Node + TypeScript.
If there is anything specific that you wish was included (or more detailed) in this README or project setup, please [open an issue](https://github.com/bowdenk7/express-typescript-starter/issues)!

If you found this guide helpful, or have any other general feedback, thoughts, questions, or requests that feel out of place on the issue tracker, please fill out this [quick survey](https://www.surveymonkey.com/r/LN2CV82) and let me know! 

And of course feel free to contact me directly over twitter or email for anything else!
